...
// Suite provides a suite of kms+crypto+cms functions.
//
// Each suite method returns an implementation of a particular kms+crypto+cms API,
...
type Suite interface {
	...
	FixedKeyCertIssuer(kid string) (FixedKeyCertIssuer, error)
...
var ErrNotImplemented = errors.New("suite does not yet implements requested behaviour")
...
// CMSCertIssuer provides certificates issuing operations.
...
// FixedKeyCertIssuer provides the common cert issuer interface, using a fixed key for each issuer instance.
type FixedKeyCertIssuer interface {
