...
func (k *kmsCrypto) FixedKeyCrypto(pub *jwk.JWK) (suiteapi.FixedKeyCrypto, error) {
	return makeFixedKeyKMSCrypto(pub.KeyID, k.km, k.cr)
}

func (k *kmsCrypto) FixedKeySigner(pub *jwk.JWK) (suiteapi.FixedKeySigner, error) {
	return makeFixedKeyKMSCrypto(pub.KeyID, k.km, k.cr)
}

func (k *kmsCrypto) FixedKeyMultiSigner(pub *jwk.JWK) (suiteapi.FixedKeyMultiSigner, error) {
	return makeFixedKeyKMSCrypto(pub.KeyID, k.km, k.cr)
}

func (k *kmsCrypto) FixedMultiSignerGivenKID(kid string) (suiteapi.FixedKeyMultiSigner, error) {
	return makeFixedKeyKMSCrypto(kid, k.km, k.cr)
}
